...
> [!TIP]
> You should spend at least 5 minutes to understand these 3 elementary things about FlexSearch to improve your results significantly: [Tokenizer](#tokenize), [Encoder](#encoder) and [Suggestions](#suggestion)
...
- Demo: Auto-Complete
- Examples Node.js:
  - [CommonJS](example/nodejs-commonjs)
  - [Module (ESM)](example/nodejs-esm)
- Examples Browser:
  - [Legacy Script](example/browser-legacy)
  - [Module](example/browser-module)
...
- new <a href="#mikado.new">**Encoder**</a>(\<options\>) : <small>_encoder_</small>
...
- document.<a href="#document.remove">__remove__</a>(id || document)
...
- document.<a href="#document.get">__set__</a>(id, object)
...
- encoder.<a href="#encoder.search">__encode__</a>(string)
- encoder.<a href="#encoder.search">__addFilter__</a>(string)
- encoder.<a href="#encoder.search">__addFilter__</a>(string => boolean)
- encoder.<a href="#encoder.search">__addMapper__</a>(char, char)
- encoder.<a href="#encoder.search">__addMatcher__</a>(string, string)
- encoder.<a href="#encoder.search">__addReplacer__</a>(regex, string)
...
The basic idea of this concept is to limit relevance by its context instead of calculating relevance through the whole distance of its corresponding document. The context acts like a bidirectional moving window of 2 terms which can have a maximum distance of the value passed via option setting `depth`.
