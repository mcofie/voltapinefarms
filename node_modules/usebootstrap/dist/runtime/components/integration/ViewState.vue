<template>
 <Suspense suspensible>
  <slot :key="slotKey" :data="data" :status="status" :update="update" :set="set" :reload="reload" :sync-result="syncResult" :sync-status="syncStatus" :validate="validate" :validation-result="validationResult" />
  <template #fallback>
   <Spinner sm />
  </template>
 </Suspense>
