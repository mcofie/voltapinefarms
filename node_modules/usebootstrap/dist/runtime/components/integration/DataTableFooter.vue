...
<template>
 <ViewState v-slot="query" src="query://" :data="{
  page: 1,
 }">
  <b-div flex>
   <b-div flex-grow="grow-1">
    <nav aria-label="Page navigation">
     <Pagination>
      <PageItem>
       <PageLink aria-label="Previous" @click="query.set('page', 1)">
        <span aria-hidden="true">&laquo;</span>
       </PageLink>
      </PageItem>
      <PageItem>
       <PageLink aria-label="Previous" @click="query.set('page', toNumber(query.data.page || 1) - 1)">
        <span aria-hidden="true">&laquo;</span>
       </PageLink>
      </PageItem>
      <PageItem>
       <PageLink aria-label="Next" @click="query.set('page', toNumber(query.data.page || 1) + 1)">
